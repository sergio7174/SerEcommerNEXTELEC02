...
import logo from "@assets/img/logo/LOGO-SERGIO.jpg";
...
const Header = () => {
  ...
  return (
    <>
      <header style={{border:'3px double lightblue', background:'radial-gradient(circle, rgba(219,215,217,1) 0%, rgba(155,197,246,1) 89%)'}}>
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-xl-2 col-lg-2 col-md-4 col-6">
                  <div className="logo">
                    <Link href="/">
                    <Image src={logo} alt="logo" priority style={{height:'6vh', width:'15vw', marginLeft:'-5vw', borderRadius:5, border:'3px double gray'}}/>
                    </Link>
                  </div>
                </div>
                  ...
                  <div className="col-xl-3 col-lg-3">
                    <div className="tp-header-contact d-flex align-items-center justify-content-end">
                      ...
                      <div className="tp-header-contact-content">
                        <h5>Hotline:</h5>
                        <p>
                          <a href="tel:+058 412 94 03 149">+(058) 412 94 03 149</a>
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {/* sticky header start */}
      <div id="header-sticky-2" className={`tp-header-sticky-area ${sticky ? 'header-sticky-2' : ''}`}  style={{border:'3px double lightblue', background:'radial-gradient(circle, rgba(219,215,217,1) 0%, rgba(155,197,246,1) 89%)'}}>
        <div className="container">
          <div className="tp-mega-menu-wrapper p-relative">
            <div className="row align-items-center">
