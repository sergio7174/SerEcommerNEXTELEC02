      ...
      <div className="tp-header-login d-none d-lg-block">
        <div className="d-flex align-items-center">
          ...
          <div className="tp-header-login-content d-none d-xl-block">
            ...
            {/* ADMIN DASHBOARD OPTION - BLOCK BEGINING */}
            {/*{(userInfo?.role=='Admin') && <span>{userInfo?.role}</span>}*/}
            {(userInfo?.role=='Admin') && <Link href="/AdminDashboard" style={{color:'red'}}>Go to Admin DashB</Link>}
             {/* ADMIN DASHBOARD OPTION - BLOCK END */}
          </div>
        </div>
      </div>
