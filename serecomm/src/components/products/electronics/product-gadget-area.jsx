...
const ProductGadgetArea = () => {
  ...
  return (
    <>
      <section className="tp-product-gadget-area pt-80 pb-75" style={{background: 'linear-gradient(139deg, rgba(22,103,184,1) 2%, rgba(9,83,121,1) 11%, rgba(0,193,255,0.9191876579733456) 58%)'}}>
